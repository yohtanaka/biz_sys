...
<table class="form-group">
    <tr>
        ...
        <td>{!! Form::email('email', null, ['class' => 'form-control form-inline']) !!}</td>
    </tr>
    <tr>
        <td>{!! Form::label('role', '権限') !!}</td>
        <td>{!! Form::text('role', null, ['class' => 'form-control form-inline']) !!}</td>
    </tr>
    <tr>
        <td>{!! Form::label('code', '社員番号') !!}</td>
        <td>{!! Form::text('code', null, ['class' => 'form-control form-inline']) !!}</td>
    </tr>
    <tr>
        <td>{!! Form::label('last_name', '名前') !!}</td>
        <td>
    ...
    <tr>
        <td>{!! Form::label('l_n_kana', '名前(カナ)') !!}</td>
        <td>
    ...
    <tr>
        <td>{!! Form::label('birthday', '誕生日') !!}</td>
        <td>{!! Form::input('date', 'birthday', date('Y-m-d'), ['class' => 'form-control form-inline']) !!}</td>
    </tr>
    <tr>
        <td>{!! Form::label('zip1', '郵便番号') !!}</td>
        <td>
    ...
    <tr>
        <td>{!! Form::label('building', '建物名/部屋番号') !!}</td>
        <td>{!! Form::text('building', null, ['class' => 'form-control form-inline']) !!}</td>
    </tr>
    <tr>
        <td>{!! Form::label('tel_private', '電話番号(個人)') !!}</td>
        <td>{!! Form::number('tel_private', null, ['class' => 'form-control form-inline']) !!}</td>
    </tr>
    <tr>
        <td>{!! Form::label('tel_work', '電話番号(会社)') !!}</td>
        <td>{!! Form::number('tel_work', null, ['class' => 'form-control form-inline']) !!}</td>
    </tr>
    <tr>
        <td>{!! Form::label('section', '部署') !!}</td>
        <td>
